...
import { MAX_CONTACT_BANNER_LABEL, MAX_CONTACT_BANNER_VIDEO_LABEL } from "./limits";
import {
  saveContactPage,
  uploadContactPageBanner,
  uploadContactPageBannerVideo,
  uploadContactPageContentImage,
} from "./actions";
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageBannerFields
        ...
        uploadImageAction={uploadContactPageBanner}
        uploadVideoAction={uploadContactPageBannerVideo}
        imageSizeLabel={MAX_CONTACT_BANNER_LABEL}
        videoSizeLabel={MAX_CONTACT_BANNER_VIDEO_LABEL}
        disabled={isPending}
      />
