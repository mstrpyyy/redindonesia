...
import { MAX_PODCAST_BANNER_LABEL } from "./limits";
import { savePodcastPage, uploadPodcastPageBanner } from "./actions";
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-3">
        ...
        <p className="text-muted-foreground -mt-2 text-xs">
          Up to {MAX_PODCAST_BANNER_LABEL} each. JPEG, PNG, WEBP, or GIF.
        </p>
        ...
        <div className="flex flex-row flex-wrap justify-start gap-4">
          <div className="flex w-40 flex-col gap-1.5">
            ...
            <UploadField
              ...
              aspect="square"
              fit="cover"
              uploadAction={uploadPodcastPageBanner}
              value={bannerXlUrl}
